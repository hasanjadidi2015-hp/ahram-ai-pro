# -*- coding: utf-8 -*-
"""AHRAM AI PRO V5 — داشبورد نمایشی با Option Decision System V2.
...
<html lang="fa" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="refresh" content="{REFRESH_SECONDS}"><title>AHRAM AI PRO V5</title>
<style>
...
<header class="top"><div><h1>🚀 AHRAM AI PRO V5 - Option Decision System</h1><div class="sub">داشبورد V5 با CALL SCORE + Breakdown + RISK · فقط نمایش داده‌های فعلی ربات</div></div><div class="status"><span class="live">سیستم فعال V5</span><span>به‌روزرسانی {REFRESH_SECONDS} ثانیه</span><span>{now}</span></div></header>
...
if __name__ == "__main__":
    out = generate()
    if out:
        print(f"✅ داشبورد V5 ساخته شد: {out} + {OUTPUT_FILE_VIP5}")
